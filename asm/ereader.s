	...
	THUMB_FUNC_START state26_27_main_callback
state26_27_main_callback: @ 0x0802D6DC
	push {r4,r5,lr}
	sub sp, sp, #12
	bl process_input
	bl sub_08029C20
...
_0802DBE8:
	.4byte gUnknown_030001A8
	THUMB_FUNC_END state26_27_main_callback

	THUMB_FUNC_START state26_27_display_callback
state26_27_display_callback: @ 0x0802DBEC
	push {r4-r7,lr}
	sub sp, sp, #12
	add r4, sp, #8
	mov r0, #0
...
_0802DD48:
	.4byte 0x80000200
	THUMB_FUNC_END state26_27_display_callback

	THUMB_FUNC_START state26_27_init_callback
state26_27_init_callback: @ 0x0802DD4C
	push {r4,lr}
	sub sp, sp, #4
...
_0802DDE4:
	.4byte 0x0000FDFF
	THUMB_FUNC_END state26_27_init_callback
...
_0802DE04:
	...
	THUMB_FUNC_START state25_init_callback
state25_init_callback: @ 0x0802DE08
	push {r4-r7,lr}
	mov r7, r8
	push {r7}
	sub sp, sp, #4
...
_0802DED8:
	...
	strh r0, [r2]
	strh r4, [r7]
	ldr r1, _0802DF48  @ =gBGOffsets_03001730
...
_0802DF4C:
	.4byte 0x01000008
	THUMB_FUNC_END state25_init_callback

	THUMB_FUNC_START state24_25_main_callback
state24_25_main_callback: @ 0x0802DF50
	push {r4-r7,lr}
	mov r7, r10
	mov r6, r9
	mov r5, r8
...
_0802DFC2:
	...
	add r0, r4, #0
	strh r0, [r1]
	ldr r1, _0802E014  @ =gBGOffsets_03001730
	mov r0, #0
	strh r0, [r1]
	strh r0, [r1, #2]
	add r1, r3, #0
...
_0802E67E:
	...
	mov r0, #3
	and r1, r1, r0
	ldr r3, _0802E6D8  @ =gBGOffsets_03001730
	neg r2, r7
	lsl r0, r2, #2
	add r0, r0, r2
	lsl r0, r0, #3
...
_0802E77C:
	.4byte 0x030001C4
	THUMB_FUNC_END state24_25_main_callback
...
_0802E884:
	...
	THUMB_FUNC_START state24_25_display_callback
state24_25_display_callback: @ 0x0802E888
	push {r4-r7,lr}
	mov r7, r10
	mov r6, r9
	mov r5, r8
...
_0802EC30:
	.4byte 0x80000400
	THUMB_FUNC_END state24_25_display_callback

	THUMB_FUNC_START state24_init_callback
state24_init_callback: @ 0x0802EC34
	push {r4,r5,lr}
	mov r0, #0
	bl arena_restore_head
	bl sub_08038B18
...
_0802ECC4:
	...
	THUMB_FUNC_END state24_init_callback
...
sub_0802ECC8: @ 0x0802ECC8
	...
	add r0, r0, #80
	strh r0, [r1]
	ldr r1, _0802ECEC  @ =gBGOffsets_03001730
	lsl r0, r0, #16
	lsr r0, r0, #24
	strh r0, [r1, #12]
	bl sub_0801B310
...
_0802F1E8:
	...
	THUMB_FUNC_START state28_main_callback
state28_main_callback: @ 0x0802F1EC
	push {r4-r7,lr}
	sub sp, sp, #12
	bl process_input
	bl sub_08008238
...
_0802F43C:
	.4byte 0x030001C9
	THUMB_FUNC_END state28_main_callback

	THUMB_FUNC_START state28_display_callback
state28_display_callback: @ 0x0802F440
	push {r4-r7,lr}
	mov r7, r8
	push {r7}
	sub sp, sp, #20
...
_0802F58C:
	.4byte 0x80000200
	THUMB_FUNC_END state28_display_callback

	THUMB_FUNC_START state28_init_callback
state28_init_callback: @ 0x0802F590
...
_0802F5B8:
	.4byte 0x0000FDFF
	THUMB_FUNC_END state28_init_callback
...
_0802F6D8:
	...
	.4byte _0802F74C
_0802F6EC:
	ldr r0, _0802F6FC  @ =gMoveFrameCounter_03000B54
	ldr r0, [r0]
	bl sub_0802F5C0
	mov r1, #100
	mul r0, r1, r0
...
_0802F8CC:
	...
	cmp r0, #1
	bne _0802F91C
	ldr r1, _0802F918  @ =gBGOffsets_03001730
	mov r2, #0
	mov r0, #128
	lsl r0, r0, #1
	strh r0, [r1, #4]
...
_0802F918:
	.4byte gBGOffsets_03001730
_0802F91C:
	ldr r1, _0802F924  @ =gBGOffsets_03001730
	mov r0, #0
	strh r0, [r1, #4]
	b _0802F936
_0802F924:
...
_08031EDC:
	...
	THUMB_FUNC_START state29_main_callback
state29_main_callback: @ 0x08031EE8
	push {r4-r6,lr}
	sub sp, sp, #4
	bl process_input
	bl sub_08029C20
...
_080320E0:
	.4byte 0x0300028C
	THUMB_FUNC_END state29_main_callback

	THUMB_FUNC_START state29_display_callback
state29_display_callback: @ 0x080320E4
	push {r4,lr}
	sub sp, sp, #12
	add r4, sp, #8
	mov r0, #0
...
_08032188:
	.4byte 0x80000200
	THUMB_FUNC_END state29_display_callback

	THUMB_FUNC_START state29_init_callback
state29_init_callback: @ 0x0803218C
	push {r4,lr}
	sub sp, sp, #4
	mov r0, #0
	bl arena_restore_head
...
_080321C8:
	...
	mov r0, sp
	strh r1, [r0]
	ldr r1, _08032204  @ =gBGOffsets_03001730
...
_08032208:
	.4byte 0x01000008
	THUMB_FUNC_END state29_init_callback
