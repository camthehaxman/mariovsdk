...
sub_08008238: @ 0x08008238
	...
	lsl r3, r3, #16
	asr r3, r3, #17
	ldr r4, _080082B8  @ =gBGOffsets_03001730
	strh r2, [r4, #4]
	strh r2, [r4]
	ldr r0, _080082BC  @ =gUnknown_030012A4
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r2, r2, r0
	ldr r5, _080082C0  @ =gUnknown_03000E70
	ldr r6, [r5, #8]
	mov r1, #34
	ldrsh r0, [r6, r1]
	add r1, r2, #0
	...
	strh r3, [r4, #6]
	strh r3, [r4, #2]
	ldr r0, _080082C4  @ =gUnknown_030012EC
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r3, r3, r0
	mov r1, #36
...
_080082BC:
	.4byte gUnknown_030012A4
_080082C0:
	.4byte gUnknown_03000E70
_080082C4:
...
sub_080082C8: @ 0x080082C8
	ldr r1, _0800830C  @ =gBGOffsets_03001730
...
sub_08008330: @ 0x08008330
	...
	lsl r0, r0, #16
	asr r5, r0, #17
	ldr r6, _080083E0  @ =gUnknown_03000D38
	ldrh r0, [r6]
	cmp r0, #90
	beq _080083A6
...
_080083A6:
	...
	cmp r0, #0
	beq _08008410
	ldr r3, _080083FC  @ =gBGOffsets_03001730
...
_0800840C:
	...
	b _08008418
_08008410:
	ldr r0, _08008460  @ =gBGOffsets_03001730
	strh r4, [r0]
	strh r5, [r0, #2]
	add r6, r0, #0
_08008418:
	strh r4, [r6, #4]
	strh r5, [r6, #6]
	ldr r0, _08008464  @ =gUnknown_030012A4
	mov r3, #0
	ldrsh r0, [r0, r3]
	add r4, r4, r0
	ldr r3, _08008468  @ =gUnknown_03000E70
	ldr r2, [r3, #8]
	mov r7, #34
	ldrsh r0, [r2, r7]
	add r1, r4, #0
	...
	add r0, r0, r1
	strh r0, [r6, #12]
	ldr r0, _0800846C  @ =gUnknown_030009E0
	ldrh r1, [r0]
	add r0, r1, #0
	sub r0, r0, #160
	sub r0, r5, r0
...
_0800847E:
	strh r0, [r6, #10]
	ldr r0, _080084A0  @ =gUnknown_030012EC
	mov r2, #0
	ldrsh r0, [r0, r2]
	add r5, r5, r0
	ldr r2, [r3, #12]
...
sub_080084A4: @ 0x080084A4
	...
	lsl r0, r0, #16
	asr r6, r0, #17
	ldr r4, _08008584  @ =gUnknown_03000D38
	ldrh r0, [r4]
	cmp r0, #90
	beq _0800851A
...
_08008508:
	...
	sub r6, r6, #160
_0800851A:
	ldr r3, _0800859C  @ =gBGOffsets_03001730
	strh r5, [r3, #4]
	strh r6, [r3, #6]
	ldr r0, _080085A0  @ =gUnknown_030012A4
	mov r7, #0
	ldrsh r0, [r0, r7]
	add r5, r5, r0
	ldr r4, _080085A4  @ =gUnknown_03000E70
	ldr r2, [r4]
	mov r1, #34
	ldrsh r0, [r2, r1]
	add r1, r5, #0
	...
	add r0, r0, r1
	strh r0, [r3, #12]
	ldr r0, _080085AC  @ =gUnknown_030009E0
	ldrh r1, [r0]
	add r0, r1, #0
	sub r0, r0, #160
	sub r0, r6, r0
...
_080085BE:
	strh r0, [r3, #2]
	ldr r0, _080085F8  @ =gUnknown_030012EC
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r6, r6, r0
	ldr r1, [r4, #8]
...
sub_08008600: @ 0x08008600
	...
	lsl r3, r3, #16
	asr r3, r3, #17
	ldr r4, _0800868C  @ =gBGOffsets_03001730
	strh r2, [r4, #4]
	strh r2, [r4]
	ldr r0, _08008690  @ =gUnknown_030012A4
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r2, r2, r0
	ldr r5, _08008694  @ =gUnknown_03000E70
	ldr r6, [r5, #8]
	mov r1, #34
	ldrsh r0, [r6, r1]
	mul r0, r2, r0
	...
	strh r3, [r4, #6]
	strh r3, [r4, #2]
	ldr r0, _0800869C  @ =gUnknown_030012EC
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r3, r3, r0
	mov r1, #36
...
sub_080086A4: @ 0x080086A4
	...
	lsl r3, r3, #16
	asr r3, r3, #17
	ldr r4, _08008744  @ =gBGOffsets_03001730
	strh r2, [r4, #4]
	strh r2, [r4]
	ldr r0, _08008748  @ =gUnknown_030012A4
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r2, r2, r0
	ldr r5, _0800874C  @ =gUnknown_03000E70
	ldr r6, [r5, #8]
	mov r1, #34
	ldrsh r0, [r6, r1]
	mul r0, r2, r0
	...
	strh r3, [r4, #6]
	strh r3, [r4, #2]
	ldr r0, _08008758  @ =gUnknown_030012EC
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r3, r3, r0
	mov r1, #36
...
_08008784:
	...
	sub r5, r5, #160
_08008796:
	ldr r2, _0800880C  @ =gBGOffsets_03001730
	strh r6, [r2, #4]
	strh r6, [r2]
	ldr r0, _08008810  @ =gUnknown_030012A4
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r6, r6, r0
	ldr r3, _08008814  @ =gUnknown_03000E70
	ldr r4, [r3, #8]
	mov r1, #34
	ldrsh r0, [r4, r1]
	add r1, r6, #0
	...
	strh r5, [r2, #6]
	strh r5, [r2, #2]
	ldr r0, _08008818  @ =gUnknown_030012EC
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r5, r5, r0
	mov r1, #36
...
sub_0800881C: @ 0x0800881C
	...
	lsl r3, r3, #16
	asr r3, r3, #17
	ldr r4, _080088AC  @ =gBGOffsets_03001730
	strh r2, [r4, #4]
	strh r2, [r4]
	ldr r0, _080088B0  @ =gUnknown_030012A4
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r2, r2, r0
	ldr r5, _080088B4  @ =gUnknown_03000E70
	ldr r6, [r5, #8]
	mov r1, #34
	ldrsh r0, [r6, r1]
	add r1, r2, #0
	...
	add r0, r0, r3
	strh r0, [r4, #2]
	ldr r0, _080088BC  @ =gUnknown_030012EC
	mov r1, #0
	ldrsh r0, [r0, r1]
	add r3, r3, r0
	mov r1, #36
...
sub_080088C4: @ 0x080088C4
	ldr r0, _080088E4  @ =gBGOffsets_03001730
	mov r2, #0
	strh r2, [r0, #4]
	strh r2, [r0]
...
_08008946:
	...
	str r0, [r4, #8]
	ldr r0, [r4, #8]
	ldr r0, _08008A6C  @ =gSomeVRAMAddr_03000E80
	ldr r0, [r0]
...
_080089A8:
	...
	mov r10, r7
	ldr r1, _08008A8C  @ =gSomeVRAMAddr_03000E90
	mov r9, r1
	mov r6, #24
	and r6, r6, r0
_080089D4:
