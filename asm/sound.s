...
_0807167E:
	...
	ldr r0, [r5]
	strb r2, [r0, #2]
	ldr r1, _080717D4  @ =0x04000084
	mov r0, #128
	strh r0, [r1]
	ldr r0, _080717D8  @ =0x04000080
	mov r1, r8
	strh r1, [r0]
	ldr r1, _080717DC  @ =0x04000082
	ldr r2, _080717E0  @ =0x0000DE0C
	add r0, r2, #0
	strh r0, [r1]
	add r1, r1, #62
	ldr r0, _080717E4  @ =0x040000A0
	str r0, [r1]
	add r1, r1, #12
	add r0, r0, #4
	str r0, [r1]
	ldr r3, _080717E8  @ =0x040000BC
	ldr r1, [r5]
	ldrb r2, [r1, #6]
	lsl r0, r2, #3
	add r0, r0, r2
...
play_sound_effect_08071990: @ 0x08071990
	...
	sub r1, r1, r0
	lsl r1, r1, #2
	ldr r0, _08071A00  @ =gSoundEffectTable_08B3A4E0
	add r1, r1, r0
	mov r12, r1
	cmp r5, #15
	bls _080719D8
...
_08071BBC:
	...
	THUMB_FUNC_START dma1_interrupt_handler
dma1_interrupt_handler: @ 0x08071BCC
	push {lr}
...
_08071BDC:
	.4byte 0x03001EE8
	THUMB_FUNC_END dma1_interrupt_handler

	THUMB_FUNC_START sub_08071BE0
sub_08071BE0: @ 0x08071BE0
	ldr r0, _08071BF8  @ =0x040000C4
	mov r1, #0
	str r1, [r0]
	add r0, r0, #12
	str r1, [r0]
...
sub_08071C6C: @ 0x08071C6C
	...
	sub r1, r1, r0
	lsl r1, r1, #2
	ldr r0, _08071CC0  @ =gSoundEffectTable_08B3A4E0
	add r7, r1, r0
	mov r5, #0
...
sub_08071E14: @ 0x08071E14
	...
	sub r1, r1, r0
	lsl r1, r1, #2
	ldr r0, _08071E6C  @ =gSoundEffectTable_08B3A4E0
	add r1, r1, r0
	mov r8, r1
...
_08073B8C:
	...
	THUMB_FUNC_START tm1over_interrupt_handler
tm1over_interrupt_handler: @ 0x08073B90
	push {r4-r7,lr}
	mov r7, r9
	mov r6, r8
	push {r6,r7}
...
_08073CDA:
	...
	pop {r0}
	bx r0
	THUMB_FUNC_END tm1over_interrupt_handler
...
gUnknown_08B3A4DC:
	...
	.GLOBAL gSoundEffectTable_08B3A4E0
gSoundEffectTable_08B3A4E0:
